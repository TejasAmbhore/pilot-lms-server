...
urlpatterns = [
    ...
    path('course/check_enrollment/<int:course_id>', views.check_enrollment, name='check_enrollment'),
    path('course/<int:course_id>/video/<int:video_id>', views.course_video, name='course_video'),
    path('quiz/submit_quiz/', views.submit_quiz, name='submit_quiz'),
    path('course/<int:course_id>/course_notes/<int:note_id>', views.course_notes, name='course_notes'),
    path('dashboard/', views.dashboard, name='dashboard'),
    path('course/create_course/', views.create_course, name='create_course'),
    path('course/course_details/<int:course_id>', views.course_details, name='course_details'),
    ...
    path('course/create_module/<int:course_id>', views.create_module, name='create_module'),
    path('course/<int:course_id>/update_module/<int:module_id>', views.update_module, name='update_module'),
    path('course/<int:course_id>/delete_module/<int:module_id>', views.delete_module, name='delete_module'),
